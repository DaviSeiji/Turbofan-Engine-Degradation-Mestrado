...
class IntegratedGradientsExplainer(BaseExplainer):
    ...
    def plot_heatmap(self, index, m_steps=50):
        ...
        ax.set_xlabel("Sensores (1 a 19)", fontsize=12)
        ax.set_ylabel("Janela de Tempo (Ciclos T-29 a T)", fontsize=12)

        sensor_labels = [f"s_{i+1}" for i in range(19)]
    ...
    def plot_local_bar(self, index, m_steps=50):
        ...
        sensor_labels = [f"Sensor {i+1}" for i in range(19)]
